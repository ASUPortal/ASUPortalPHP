...
$kind_type_defaults='&kind_type1=on&kind_type2=on&kind_type3=on&kind_type4=on&filial_flag=on';		//����� �������� ����������
...
<script language="JavaScript">
    ...
    function setCat(chElement)
    {
        ...
        hrefPath=hrefPath.replace(/tab=\d+/,'tab=3');	// ��������������� �� �����
        //alert(hrefPath);
...
//if (document.hours_kind_form.group_list.value==0) {msg=msg+'\n ������;';err=true;}
    ...
    {
        document.hours_kind_form.goView.value=1;	//������� �������� � ��������
...
?>
<h4>������� �������� �����������(���) <span > <a href="hrs_rate.php">���������� ������ </a> </span> </h4>
<?php
//print_r($_SESSION);
//��� ������� ��������� �� �������
$months=array(9=>'��������','�������','������','�������','������','�������','����','������','���','����','����','������');
...
//��� ������� �������� - ������ ����������� ����� �����
$hour_kind_name=array('������', '�������.', '���������. �������', '������.-���. ������', '��������. �����. �����', '������������', '������',
    '��������', '������� ��������', '�����������. ��������', '�������� �������', '����������. ������. ������', '���', '������� � �����������',
    '����������� ��������.', '��������� �������');
$hour_kind_code=array('lects', 'practs', 'labor', 'rgr', 'recenz', 'consult', 'test', 'exams', 'study_pract', 'work_pract', 'kurs_proj', 'consult_dipl', 'gek', 'aspirants', 'aspir_manage', 'duty');
...
<?php
    ...
    echo '<p><a href="p_administration.php">� ������ �����.</a></p>';
...
{//echo '<hr>type1='.$_POST['hours_type1'].', type2='.$_POST['hours_type2'].'<hr>';
    ...
    {//echo "���������� ��������� ���������";
        ...
        if ($insert_action==true) {
            ...
            $query='insert into hours_year(kadri_id,year_id, m09, m10, m11, m12, m01, m02, m03, m04, m05, m06, m07, m08, bud_commerce)
				           values("'.$_GET['kadri_id'].'","'.$_POST['year_id'].'" '.$insert_string.',"������")';
            //echo "<hr>".$query;
            if (mysql_query($query)) {echo "<br>��������� ��������� �� ����������: <b>".$fio."</b> ������� ���������";}
            else {echo "<br>��������� ��������� �� ���������...";}
        }
        else {echo '<br><font color=red>��������� ��������� �� ���������......�� ������� ����������� ������ .</font>';}
    }
    ...
    {//echo "��������� ��������� ���������";
        $query='update hours_year set year_id="'.$_POST['year_id'].'", m09="'.$_POST['elBudget_1'].'",m10="'.$_POST['elBudget_2'].'",
	                   ...
	                   m08="'.$_POST['elBudget_12'].'" where kadri_id="'.$_GET['kadri_id'].'" and bud_commerce="������"';
        //echo "<hr>".$query;
        if (mysql_query($query)) {echo "<br>��������� ��������� �� ����������: <b>".$fio."</b> ������� ���������";}
        else {echo "<br><font color=red>��������� ��������� �� ���������...</font>";}
    }
    ...
    {//echo "��������� ������������ ���������";
        $query='update hours_year set year_id="'.$_POST['year_id'].'", m09="'.$_POST['elComm_1'].'",m10="'.$_POST['elComm_2'].'",
	                   ...
	                   m08="'.$_POST['elComm_12'].'" where kadri_id="'.$_GET['kadri_id'].'" and bud_commerce="��������"';
        //echo "<hr>".$query;
        if (mysql_query($query)) {echo "<br>��������� ������������ �� ����������: <b>".$fio."</b> ������� ���������";}
        else {echo "<br><font color=red>��������� ������������ �� ���������...</font>";}
    }
...
if (array_key_exists("type_kind", $_POST)) {
    if ($_POST['type_kind']=="insert") {
        ...
        if ($insert_action1==true && $insert_action2==true) {
            ...
            if (mysql_query($query)) {
                echo "<div class=success>�������� �� ����������: <b>".$fio."</b> ������� ���������</div>";
            } else {
                echo "<br><font color=red>��������  �� ���������...�������� ����� ������ ��� ����.</font>";
            }
        } else {
            echo '<br><font color=red>��������  �� ���������...';
            if (!$insert_action1) {echo ' �� ������� ����������� ������ (��� ������ �� ������..��������� ������� ������).';}
            if (!$insert_action2) {echo ' �� ��������� �����������. ��������� ��������� ��� ������ ������ (���..������)';}
            echo '</font>';
        }
    }
    ...
    if ($_POST['type_kind']=="update") {
        ...
        //echo '<hr>'.$query;
        if (mysql_query($query)) {echo "<div class=success>�������� �� ����������: <b>".$fio."</b> ������� ���������.</div>";
            if ($_POST['goView']==1) {echo '����������� � ������ ����� 2 ���.<script language="Javascript">setTimeout("window.location.href=\"'.'s_hours_view.php?kadri_id='.$_GET['kadri_id'].'&year='.$_POST['year_id'].$kind_type_defaults.'\"",100);</script>';}
        }
        else {echo "<br><font color=red>�������� �� ���������...�������� ��������� ���������.</font>";}
    }
}
...
<p><a href="lect_anketa.php?kadri_id=<?php echo $_GET['kadri_id']; ?>&action=update">��������� � ������...</a><p>
...
<table border="0" bordercolor="#F0F0F0" cellpadding="0" cellspacing="0" width="100%">
    <tr bgcolor="#E6E6FF">
        <!--td height=40 id="c1" onMouseOver="newColor('c1');" onMouseOut="backColor('c1');" onClick="Click_color('c1',3);" width="200">
          <div align="center" style="display:none;"><font size="3"><b><a href="javascript:show_hide('Layer1');">���������</a> </b></font></div>
        </td-->
...
$query_all='SELECT * FROM hours_year
          where kadri_id='.$_GET['kadri_id'].' and bud_commerce="������" limit 0,1';
//echo $query_all;
    ...
    <form name=orders_form action="s_hours.php?kadri_id=<?php echo $_GET['kadri_id']; ?>&tab=2" method="post">
        <table name=tab1 cellpadding="0" cellspacing="10" bgcolor="#E6E6FF" width="100%">
            <tr><td colspan=2 align="left" valign="bottom" height="27">
                <?php if (isset($res_edit_1)) {echo '<a href="s_hours_subj.php?kadri_id='.$_GET['kadri_id'].'">������ ������������ ��������� </a>';}
            else {echo '������ ��������� ���������� (�� ������� ���������)';} ?>
            </td></tr>
            ...
            <tr valign="middle" height="44">
                ...
                <td width=200><input type="reset" value="��������"></td>
                <td width=200><input type="button" value="�������" onclick="javascript:help_msg();"></td>
            </tr>

            <tr><td colspan=2 align="center" valign="bottom" height="27"><b>���������:</b></td></tr>
            <tr>
                <td width="400" colspan="3">
                    <input name="elem10" type="hidden" value="<?php if (isset($res_edit)) {echo $res_edit['id'];} echo '" '.$disabled_val; ?>>
    </td>
  </tr>
  <tr><td> ��� </td><td colspan=2>	<select name="year_id" style="width:300;">
            ...
            <tr>
                <td width="275"> ��� ��������� (������\��������)</td>
                <td width="">
                    <?php if (isset($res_edit_1)) {echo '<div style="background-color:#3399FF; font-weight:bold"> ������ </div>';} else {echo '������';}?>
                </td>
                <td width="">
                    <?php if (isset($res_edit_2)) {echo '<div style="background-color:#3399FF; font-weight:bold"> �������� </div>';} else {echo '��������';}?>
                </td>
            </tr>
            <?php
            $j=9;$str='';
  	...
  	<td>����� �����: '.($bud_sum+$comm_sum).' </td><td>������: '.$bud_sum.'</td><td>��������: '.$comm_sum.'</td></tr>';
            ?>

            <tr valign="middle" height="44">
                <td width=200>	<input type="submit" value="��������"></td>
                <td width=200><input type="reset" value="��������"></td>
                <td width=200><input type="button" value="�������" onclick="javascript:help_msg();"></td>
            </tr>
        </table></form></div>
...
//$type_kind="insert";
        ...
        <table border=0 name=tabLayer2 cellpadding="0" cellspacing="10" bgcolor="#E6E6FF" width="100%">
            <tr>
		 	...
		 	from kadri k left join kadri_in_ptypes kpt on k.id = kpt.kadri_id left join person_types pt on pt.id=kpt.person_type_id where pt.name_short like '%���%' 
			order by k.fio_short";
                    }
                    else {	//��� ������������� ������ �������� ����� ����������
                        $query='select k.id,k.fio
		 	from kadri k left join kadri_in_ptypes kpt on k.id = kpt.kadri_id left join person_types pt on pt.id=kpt.person_type_id
			where pt.name_short like \'%���%\' and k.id="'.trim($_GET['kadri_id']).'" order by k.fio ';};
            ...
            <tr><td colspan=2 align="left" valign="bottom" height="27">
                <a id=view_hours_form href="#?" onClick="javascript:document.location.href='s_hours_view.php?kadri_id=<?php echo $_GET['kadri_id']; ?>'+'&year='+document.hours_kind_form.year_id.value+'<?php echo $kind_type_defaults;?>'"> ����������� �������� </a> </td></tr>
            <tr valign="middle" height="44">
                <td width=400>
                    <input type=hidden name="type_kind" value="<?php echo $type_kind; ?>">
                    <input type="button" value="��������" onClick="javascript:test_hours_kind_form();">
                    <input type="button" value="�������� � �����������" onclick="javascript:test_hours_kind_form_and_view();">
                </td>

                <td width=*><input type="reset" value="��������"></td>
                <td><input type="button" value="�������" onclick="javascript:help_msg();"></td>
            </tr>
            <tr><td colspan=2 align="center" valign="bottom" height="27"><b>��������:</b></td></tr>
...
//����� ������ ���������, ����-�, ������, �����
            //��������� � ������ ��� ���������� ������
            echo '
	<tr><td> ��� * <span class=text>(�� ��������� �������)</span></td><td>
	<select name="year_id" id="year_id" style="width:300;">';
            ...
            echo '
	<tr><td> ������� * <span class=text>(�� ��������� �������)</span></td><td>	<select name="part_id" style="width:300;">';
...
//------------------------------------------------------------------------------
            ?>
            <tr><td> ��� ��������</td><td>	<select name="hours_kind_type" style="width:300;">
                <?php
            ...
            <tr><td> ����� ���������</td>
                <td class=text>
                    <input type=text maxlength="3" value="<?php if (isset($res_edit)) {echo numLocal($res_edit['stud_cnt'],'browse');} ?>" name="stud_cnt" style="width:40;text-align:right;" id="stud_cnt" onChange="javascript:calc_sum('stud_cnt');"> ������
                    <input type=text maxlength="3" value="<?php if (isset($res_edit)) {echo numLocal($res_edit['stud_cnt_add'],'browse');} ?>" name="stud_cnt_add" style="width:40;text-align:right;" id="stud_cnt_add" onChange="javascript:calc_sum('stud_cnt');"> ���������
...
<span style="padding-left:50;">��������</span></td></tr>';
// ����� ����� ��� ������ ����� �������� (������, ��������, ...)
  ...
  <tr>
    ...
    <td width="472">
      <input name="kind_'.($i+1).'" title="������" type=text value="'.numLocal($res_edit_el,'browse').'" size=10 class="numb"  onChange="javascript:calc_sum(\'kind_'.($i+1).'\');"> &nbsp;
      <input name="kind_'.($i+1).'_add" title="���������" type=text value="'.numLocal($res_edit_el_add,'browse').'" size=10 class="numb" onChange="javascript:calc_sum(\'kind_'.($i+1).'\');"> &nbsp;
      <span name="kind_'.($i+1).'_sum" title="��������" class="text" disabled style="padding-left:40;text-align=right";>
      '.numLocal(number_format($res_edit_el+$res_edit_el_add,1,',',''),'browse').'</span>      
            ...
            <tr valign="middle" height="44">
                <td>	<input type="button" value="��������" onClick="javascript:test_hours_kind_form();">&nbsp;
                    <input type="button" value="�������� � �����������" onclick="javascript:test_hours_kind_form_and_view();"></td>
...
<tr height="50" >
    <td colspan=15 align="LEFT" valign="center" height="27">
        ...
        if (!isset($_GET['save']) && !isset($_GET['print']))
        { echo '<a href="?'.$query_string.'&print">������</a>'; }	else { echo '<a href="?'.reset_param_name($query_string,'print').'">��������</a>';}
        ?>
		...
		<?php	// ���������� �� ��������� ������� ����������
            ...
            ?>
            <label><input type=checkbox id=main_cat onclick="setCat(this);" <?php echo ($main_cat?"checked":"") ?> >������&nbsp;</label>&nbsp;
		<label><input type=checkbox id=add_cat onclick="setCat(this);" <?php echo ($add_cat?"checked":"") ?> >���������&nbsp;</label>
	
	<span style="padding-left:20; font-weight:bold;"> �����:&nbsp;<?php
...
<tr class=title height="30" align=center>
    ...
    <td>��� �������������</td>
    <td>����.</td>
    <td>������ ���� <a href="#ratedetail" class=help title="������� �� ����������">?</a></td>
    <td>������ ����<a href="#rateplan" class=help title="������� �� ����������">?</a></td>
    <td>����� �����</td>
    <td>����� ����.</td>
    <td>���.</td>
    <td>���.</td>
...
while ($a=mysql_fetch_array($res)) 	{
	...
	<a href="s_hours_view.php?kadri_id='.$a['kadri_id'].'&year='.$a['year_id'].$kind_type_defaults.'" title="�����������">
				<img src="images/toopen.png" alt="�����������" border="0"></a> &nbsp; 
	<a href="s_hours.php?kadri_id='.$a['kadri_id'].'&tab=2" title="��������">
				<img src="images/new_elem.gif" alt="��������" border="0"></a>				
				</td>';
    }
    echo '<td>&nbsp;'.$i.'</td><td>&nbsp;<a href="#fullname" title="'.$a['fio'].'" style="color:#ff0000;">'.$a['fio_short'].'</a><a href="#redmark" class=help title="������� �� ����������">?</a></td>
	<td>&nbsp;'.$a['dolgnost'].'</td>
	<td>&nbsp;</td>
...
<div class=text><b>����������:</b> <a href="#top">������� ������</a><br>
    <ul>
        <li><a name="redmark"></a><span style="color:#ff0000;font-weight:bold;"> ������� </span> �������� ���������� ���, � ������� ��� �������� (=0) � ��������� ������� ����</li>
        <li><a name="ratedetail"></a><b>������ �����������</b> �������������� ����� ������� (����� ����� � ����) �� (�������� ���� �� ��������� ��������� ���)  � ���������� �� 2-� ������ ����� ������� </li>
        <li><a name="rateplan"></a><b>������ ��������</b> �������������� ����� ������������ ������ �� ���� <u>�����������</u> (���� ��������� ������� �� �������) �������� ����������. <br/>������������� <sup>������� ��������</sup> ����������� ����� ��������� ��� ������ ��������</li>
    </ul>
</div>
</div>

<p><a href="lect_anketa.php?kadri_id=<?php echo $_GET['kadri_id']; ?>&action=update">��������� � ������...</a><p>
<p><a href="p_administration.php">� ������ �����.</a></p>
