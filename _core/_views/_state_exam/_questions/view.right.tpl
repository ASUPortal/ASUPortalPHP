...
<p>
    <a href="?action=edit&id={$question->getId()}"><center>
...
<p>
    <a href="?action=remove&id={$question->getId()}"><center>
        <img src="{$web_root}images/{$icon_theme}/32x32/actions/edit-delete.png">
        Удалить вопрос
    </center></a>
</p>