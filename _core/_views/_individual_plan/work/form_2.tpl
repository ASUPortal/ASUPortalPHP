<div class="control-group">
    ...
    <div class="controls">
        {CHtml::activeDropDownList("title_id", $object, CIndPlanManager::getWorklistByCategory(CIndPlanPersonWorkType::STUDY_AND_METHODICAL_LOAD), "", "", $object->restrictionAttribute())}
