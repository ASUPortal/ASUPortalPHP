<form action="organizational.php" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            {CHtml::activeDropDownList("id_vidov_rabot", $object, CIndPlanManager::getWorklistByCategory(2))}
