    ...
    <table class="table">
        {foreach $load->getConclusions()->getItems() as $c}
            <tr>
                ...
                <td width="16"><a href="#" class="icon-trash" onclick="if (confirm('Действительно заключение?')) { location.href='load/conclusions.php?action=delete&id={$c->getId()}'; }; return false;"></a></td>
