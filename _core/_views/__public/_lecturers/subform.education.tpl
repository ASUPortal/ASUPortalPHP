<ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#tab-education-aspir">Подготовка аспирантов, текущие ({$lect->getAspirCurrent()->getCount()})</a></li>
	<li><a data-toggle="tab" href="#tab-education-aspirOld">Подготовка аспирантов, архив ({$lect->getAspirOld()->getCount()})</a></li>
</ul>
