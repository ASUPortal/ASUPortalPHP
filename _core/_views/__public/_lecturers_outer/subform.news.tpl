...
<div class="tab-content">
	<div class="tab-pane active" id="tab-news-subjects">
        {include file="__public/_lecturers_outer/subform.news.subjects.tpl"}
    </div>
    <div class="tab-pane" id="tab-news-page">
        {include file="__public/_lecturers_outer/subform.news.page.tpl"}
    </div>
    <div class="tab-pane" id="tab-news-current">
        {include file="__public/_lecturers_outer/subform.news.current.tpl"}
    </div>
        <div class="tab-pane" id="tab-news-old">
        {include file="__public/_lecturers_outer/subform.news.Old.tpl"}
    </div>
</div>