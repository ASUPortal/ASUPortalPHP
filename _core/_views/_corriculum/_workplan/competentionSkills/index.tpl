    ...
    {else}
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            {foreach $objects->getItems() as $object}
                <tr>
                    <td><a href="#" class="icon-trash" onclick="if (confirm('Действительно удалить умение компетенции')) { location.href='workplancompetentionskills.php?action=delete&id={$object->getId()}'; }; return false;"></a></td>
                    <td>{$object->ordering}</td>
                    <td><a href="workplancompetentionskills.php?action=edit&id={$object->getId()}">{$object->skill}</a></td>
        ...
        {CHtml::paginator($paginator, "workplancompetentionskills.php?action=index")}
    {/if}
{/block}
