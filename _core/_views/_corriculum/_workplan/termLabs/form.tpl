<form action="workplantermlabs.php" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="control-group">
        {CHtml::activeLabel("lab_num", $object)}
        <div class="controls">
            {CHtml::activeTextField("lab_num", $object)}
            {CHtml::error("lab_num", $object)}
        </div>
    </div>
