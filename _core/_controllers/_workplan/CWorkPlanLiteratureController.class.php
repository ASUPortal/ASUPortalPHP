...
class CWorkPlanLiteratureController extends CBaseController{
    ...
    public function actionIndex() {
        ...
        if (CRequest::getInt("type") == CWorkPlanLiteratureTypeConstants::WORKPLAN_BASE_LITERATURE or CRequest::getInt("type") == CWorkPlanLiteratureConstants::WORKPLAN_ADDITIONAL_LITERATURE) {
