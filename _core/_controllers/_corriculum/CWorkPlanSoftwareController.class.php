<?php
class CWorkPlanSoftwareController extends CBaseController{
    ...
    public function actionIndex() {
        ...
        $this->addActionsMenuItem(array(
            "title" => "Добавить",
            "link" => "workplansoftware.php?action=add&id=".CRequest::getInt("plan_id"),
            "icon" => "actions/list-add.png"
        ));
        /**
         * Отображение представления
         */
        $this->renderView("_corriculum/_workplan/software/index.tpl");
    }
    public function actionAdd() {
        ...
        $this->addActionsMenuItem(array(
            "title" => "Назад",
            "link" => "workplansoftware.php?action=index&plan_id=".$object->plan_id,
    ...
    public function actionEdit() {
         ...
         * Отображение представления
         */
        $this->renderView("_corriculum/_workplan/software/edit.tpl");
    }
    ...
    public function actionSave() {
        ...
        if ($object->validate()) {
            ...
            if ($this->continueEdit()) {
                $this->redirect("workplansoftware.php?action=edit&id=".$object->getId());
            } else {
                $this->redirect("workplansoftware.php?action=index&plan_id=".$object->plan_id);
            }
            return true;
        }
        $this->setData("object", $object);
