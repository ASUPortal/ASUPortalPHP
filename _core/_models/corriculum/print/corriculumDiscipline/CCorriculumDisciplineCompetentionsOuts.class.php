...
class CCorriculumDisciplineCompetentionsOuts extends CAbstractPrintClassField {
    public function getFieldName()
    {
        return "Исходящие компетенции дисциплины учебного плана";
    }
    ...
    public function execute($contextObject)
    {
		...
		//массив последующих дисциплин из рабочих программ дисциплины учебного плана
