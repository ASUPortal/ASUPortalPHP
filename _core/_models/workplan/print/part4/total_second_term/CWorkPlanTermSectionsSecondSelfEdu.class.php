...
class CWorkPlanTermSectionsSecondSelfEdu extends CAbstractPrintClassField {
    public function getFieldName()
    {
        return "Нагрузка для второго семестра в списке. Самостоятельная работа студента";
    }
