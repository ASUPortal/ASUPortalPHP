...
class CCourseProjectsTaskWorkOrProjectNominative extends CAbstractPrintClassField {
    public function getFieldName()
    {
        return "Курсовой проект или курсовая работа для курсового проектирования (именительный падеж)";
    }
