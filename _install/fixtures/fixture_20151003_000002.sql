...
ALTER TABLE `pl_corriculum_workplan_projects` ADD `type` INT NOT NULL AFTER `project_title`;
...
ALTER TABLE `pl_corriculum_workplans` CHANGE `date_of_formation` `date_of_formation` DATE NOT NULL;